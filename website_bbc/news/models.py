...
class News(models.Model):
    ...
    description = models.CharField(max_length=500, help_text="Give a short description of the news, it will be displayed on the homepage under events (max 500 characters)")
